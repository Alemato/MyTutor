...
export class PopoverRicercaLezioniDisponibiliComponent implements OnInit {
  ...
  subFiltro() {
    ...
    const obj = {
      ...
      startHour: new Date(this.filtroRicerca.controls.startHour.value).getHours().toString() + ':00:00',
      endHour: new Date(this.filtroRicerca.controls.endHour.value).getHours().toString() + ':00:00',
